...
------------------------------------------------------------------------------
-- data_coherence_controller.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
--
------------------------------------------------------------------------------
-- Filename:          data_coherence_controller.vhd
-- Version:           1.00.a
-- Description:       Top level design, instantiates library components and user logic.
-- Date:              Mon Jul 08 14:36:45 2013 (by Create and Import Peripheral Wizard)
...
use data_coherence_controller_v1_00_a.user_logic;
...
entity data_coherence_controller is
  generic
  (
  ...
  (
	...
	-- DCC2JAIP_RISC_access_lock_out  : out std_logic ; -- add by T.H.Wu , 2013.9.6
...
end entity data_coherence_controller;

------------------------------------------------------------------------------
-- Architecture section
------------------------------------------------------------------------------

architecture IMP of data_coherence_controller is
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity data_coherence_controller_v1_00_a.user_logic
    generic map
    (
    ...
    (
      ...
      DCC_0_data_out                 => DCC_0_data_out,
		...
		JAIP2COOR_cmd1				=>	JAIP2COOR_cmd1,
		DCC_1_w_en_in                  => DCC_1_w_en_in,
	  DCC_1_r_en_in                  => DCC_1_r_en_in,
      DCC_1_addr_in                  => DCC_1_addr_in,
      DCC_1_data_in                  => DCC_1_data_in,
	  JAIP2COOR1_pending_resMsgSent	=>	JAIP2COOR1_pending_resMsgSent,
	  DCC_1_ack_out                  => DCC_1_ack_out,
	  DCC_1_en_out                   => DCC_1_en_out,
      DCC_1_addr_out                 => DCC_1_addr_out,
      DCC_1_data_out                 => DCC_1_data_out,

	  -- in/out port for core 2
		JAIP2COOR_cmd2				=>	JAIP2COOR_cmd2,
		DCC_2_w_en_in                  =>	DCC_2_w_en_in,
		DCC_2_r_en_in                  =>	DCC_2_r_en_in,
	  DCC_2_addr_in                	 =>	DCC_2_addr_in ,
	  DCC_2_data_in               	 => DCC_2_data_in ,
	  JAIP2COOR2_pending_resMsgSent	=>	JAIP2COOR2_pending_resMsgSent,
		DCC_2_ack_out                  =>	DCC_2_ack_out,
		DCC_2_en_out                   =>	DCC_2_en_out,
	  DCC_2_addr_out            	 => DCC_2_addr_out ,
	  DCC_2_data_out               	 => DCC_2_data_out ,
	  -- in/out port for core 3
		JAIP2COOR_cmd3				=>	JAIP2COOR_cmd3,
		DCC_3_w_en_in               =>	DCC_3_w_en_in,
		DCC_3_r_en_in               =>	DCC_3_r_en_in,
	  DCC_3_addr_in                	=>	DCC_3_addr_in ,
	  DCC_3_data_in                	=>	DCC_3_data_in  ,
	  JAIP2COOR3_pending_resMsgSent	=>	JAIP2COOR3_pending_resMsgSent,
		DCC_3_ack_out               =>	DCC_3_ack_out,
		DCC_3_en_out                =>	DCC_3_en_out,
	  DCC_3_addr_out              	=>	DCC_3_addr_out ,
	  DCC_3_data_out            	=>	DCC_3_data_out , 
