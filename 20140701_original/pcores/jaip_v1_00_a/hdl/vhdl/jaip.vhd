...
begin
  ...
  USER_LOGIC_I : entity jaip_v1_00_a.user_logic
    ...
    (
		...
		debug_current_heap_ptr=>debug_current_heap_ptr,
		debug_AllocSize       =>debug_AllocSize,
		debug_jpl_mst_address =>debug_jpl_mst_address,
		debug_fet_instrs_pkg  =>debug_fet_instrs_pkg,
		debug_GC_state        =>debug_GC_state,
		debug_GC_Mstate       =>debug_GC_Mstate,
		debug_GC_ref          =>debug_GC_ref,
		debug_GC_outC         =>debug_GC_outC,		
		debug_GC_Rcount       =>debug_GC_Rcount,
		debug_GC_M_ref        =>debug_GC_M_ref,
		debug_M_addr          =>debug_M_addr,
		debug_Mthd_Addr       =>debug_Mthd_Addr,
		debug_cur_GC_useaddr =>debug_cur_GC_useaddr,
		
		debug_GC_fMthd_Enter  =>debug_GC_fMthd_Enter,
		debug_GC_Mthd_Enter   =>debug_GC_Mthd_Enter,
		debug_GC_Mthd_Exit    =>debug_GC_Mthd_Exit,
		debug_Alloc_en        =>debug_Alloc_en,
		debug_ext_wr_heap_ptr =>debug_ext_wr_heap_ptr,
		debug_IP2Bus_MstRd_Req=>debug_IP2Bus_MstRd_Req,
		debug_IP2Bus_MstWr_Req=>debug_IP2Bus_MstWr_Req,
		debug_stall_all       =>debug_stall_all,
		debug_rrayAlloc_en    =>debug_rrayAlloc_en,
		debug_areturn         =>debug_areturn,
		debug_normal_last_sear_flag =>debug_normal_last_sear_flag,
    -- for multicore , data coherence controller use
